...
O Code Server não monta o checkout interno do EasyPanel como diretório gravável.
...
4. Em `RUN_MODE=server` (HOM e PROD), Django e Expo continuam sendo construídos a partir do checkout controlado pelo EasyPanel/Git.
